...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('tires', function (Blueprint $table) {
            ...
            $table->integer('kolicina_na_stanju')->default(0)->after('veleprodajna_cijena');
    ...
    {
        Schema::table('tires', function (Blueprint $table) {
            $table->dropColumn(['nabavna_cijena', 'maloprodajna_cijena', 'veleprodajna_cijena', 'kolicina_na_stanju', 'kategorija', 'sezona']);
        });
    }
